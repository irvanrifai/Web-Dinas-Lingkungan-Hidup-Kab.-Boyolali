      ...
      <ul class="nav navbar-nav me-auto my-2 my-lg-0" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item dropdown1">
          <a class="nav-link dropdown-toggle js-scroll-trigger" href="profil.php" id="Dropdownprofile" role="button" data-bs-toggle="dropdown" aria-expanded="false">Profil</a>
            ...
            <li><a class="dropdown-item" data-toggle="tab" href="#struktur_org">Struktur Organisasi</a></li>
            <li><a class="dropdown-item" data-toggle="tab" href="#visi_misi">Visi dan Misi</a></li>
            <li><a class="dropdown-item" data-toggle="tab" href="#tujuan">Tujuan</a></li>
			<li><a class="dropdown-item" data-toggle="tab" href="#personil">Personil</a></li>
         </ul>
        </li>
		<li class="nav-item dropdown1">
        ...
        <li class="nav-item dropdown1">
          <a class="nav-link dropdown-toggle js-scroll-trigger" href="../pelayanan/pelayanan.php" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Pelayanan
          </a>
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
			...
			<li><a class="dropdown-item" data-toggle="tab" href="../pelayanan/pelayanan.php#ukl_upl">UKL-UPLL</a></li>
...
<?php foreach ($home as $row): ?>
		...
		<iframe width="900" height="600" src="../file/<?= $row["struktur"]?>" title="struktur_org" frameborder="0"></iframe>	
		</div>
<?php endforeach;?>
</div>
</span>
...
<?php foreach ($home as $row): ?>
		<div class="embed-responsive">
		<iframe width="900" height="600" src="../file/<?= $row["visi_misi"]?>" title="visi_misi" frameborder="0"></iframe>	
		</div>
<?php endforeach;?>
</div>
</span>
...
<?php foreach ($home as $row): ?>
		<div class="embed-responsive">
		<iframe width="900" height="600" src="../file/<?= $row["tujuan"]?>" title="tujuan" frameborder="0"></iframe>	
		</div>
<?php endforeach;?>
</div>
</span>
...
<?php foreach ($home as $row): ?>
		<div class="embed-responsive">
		<iframe width="900" height="600" src="../file/<?= $row["personil"]?>" title="personil" frameborder="0"></iframe>	
		</div>
<?php endforeach;?>
</div>
</span>
