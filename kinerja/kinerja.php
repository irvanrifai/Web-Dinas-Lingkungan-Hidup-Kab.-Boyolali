    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="nav navbar-nav me-auto my-2 my-lg-0" style="--bs-scroll-height: 100px;">
		...
		<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" data-toggle="tab" href="#std_pelayanan">Standar Pelayanan</a></li>
            <li><a class="dropdown-item" data-toggle="tab" href="#renstra">Renstra</a></li>
            <li><a class="dropdown-item" data-toggle="tab" href="#org_kepeg">Organisasi, Kepeg, Keu</a></li>
			<li><a class="dropdown-item" data-toggle="tab" href="#info_izin">Informasi dan Perizinan</a></li>
			<li><a class="dropdown-item" data-toggle="tab" href="#sop_B3">SOP B3 dan Syarat</a></li>
			<li><a class="dropdown-item" data-toggle="tab" href="#sop_Pengaduan">SOP Pengaduan</a></li>
          </ul>  
		</li>
        <li class="nav-item dropdown1">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
			...
			<li><a class="dropdown-item" data-toggle="tab" href="../pelayanan/pelayanan.php#kelola_sampah">Pengelolaan Sampah</a></li>
...
<?php foreach ($home as $row): ?>
		...
		<iframe width="900" height="600" src="../file/<?= $row["std_pelayanan"]?>" title="std_pelayanan" frameborder="0"></iframe>	
		</div>
<?php endforeach;?>
</div>
</span>
...
<?php foreach ($home as $row): ?>
		<div class="embed-responsive">
		<iframe width="900" height="600" src="../file/<?= $row["renstra"]?>" title="renstra" frameborder="0"></iframe>	
		</div>
<?php endforeach;?>
</div>
</span>
...
<?php foreach ($home as $row): ?>
		<div class="embed-responsive">
		<iframe width="900" height="600" src="../file/<?= $row["org_kepeg"]?>" title="org_kepeg" frameborder="0"></iframe>	
		</div>
<?php endforeach;?>
</div>
</span>
...
<?php foreach ($home as $row): ?>
		<div class="embed-responsive">
		<iframe width="900" height="600" src="../file/<?= $row["info_izin"]?>" title="info_izin" frameborder="0"></iframe>	
		</div>
<?php endforeach;?>
</div>
</span>
...
<?php foreach ($home as $row): ?>
		<div class="embed-responsive">
		<iframe width="900" height="600" src="../file/<?= $row["sop_b3"]?>" title="sop_b3" frameborder="0"></iframe>	
		</div>
<?php endforeach;?>
</div>
</span>
...
<?php foreach ($home as $row): ?>
		<div class="embed-responsive">
		<iframe width="900" height="600" src="../file/<?= $row["sop_pengaduan"]?>" title="sop_pengaduan" frameborder="0"></iframe>	
		</div>
<?php endforeach;?>
</div>
</span>
